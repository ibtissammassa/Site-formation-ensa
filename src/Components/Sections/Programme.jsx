...
function Programme({ format }) {
    ...
    return (
        <>
            {
                (format == 'cards') &&
                <div id="Programme" className="my-24 relative flex flex-col lg:h-screen w-full px-8 lg:px-48 2xl:px-[30rem] justify-center items-center">
                    <div className="flex flex-col gap-3 text-center items-center py-8">
                    ...
                    <div className="flex md:flex-row flex-col items-center w-full z-10">
                        <SemesterCard semester={Programme[0].semester} points={Programme[0].points} />
                        <Image className="md:hidden z-0 h-16" src={red_vert_line} alt="red-vert-line" />
                    ...
                    <Image className="md:ml-[60%] z-0 h-16 md:h-auto" src={red_vert_line} alt="red-vert-line" />
                    <div className="flex md:flex-row flex-col items-center w-full z-10">
