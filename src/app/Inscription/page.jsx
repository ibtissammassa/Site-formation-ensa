    ...
    <div className="px-28 py-8 flex gap-9 flex-col">
      <div className="flex flex-col gap-3">
        ...
        <p className="text-slate-700 text-sm">
          Sécurité Informatique & Intelligence Artificielle : Renforcer les
          Défenses Numériques pour Demain
        </p>
      </div>
        ...
        <div className="w-[51%] flex flex-col gap-7">
          ...
          <div className="px-6 flex flex-col gap-3">
            ...
            <p className="text-sm text-slate-700 pl-2">
              La formation diplômante de l'Université Ibn Zohr offre une
              opportunité exceptionnelle aux étudiants intéressés par la
              cybersécurité, la cyberdéfense et l'intelligence artificielle.
            </p>
            <p className="text-sm text-slate-700 pl-2">
              Dispensée par des experts confirmés et constamment actualisée,
              cette formation combine théorie et pratique pour développer des
              compétences recherchées dans ces domaines en pleine évolution. Les
              étudiants bénéficient d'un enseignement de qualité, axé sur les
              dernières avancées technologiques, et obtiennent un diplôme
              reconnu, ouvrant ainsi des portes vers des carrières prometteuses
          ...
          <div className="px-6 flex flex-col gap-3">
            ...
            <ul className="text-sm list-disc text-slate-800 pl-6">
              ...
              <li>
                Coût de formation: 25000 Dh par an + 500Dh Frais de dossier{" "}
              </li>
              <li>Durée de la formation : 2 ans</li>
              <li>
                Déroulement de la formation: Samedi, Dimanche, et possiblement
                le soir des autres jours.
              </li>
